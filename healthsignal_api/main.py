...
ROLES={"administrator","clinician","nutritionist_dietitian","disease_control_officer","field_officer","data_officer","pharmacist","laboratory_officer","opd_nurse","records_officer","ward_nurse","midwife","theatre_staff","stores_officer","revenue_officer","accountant","insurance_officer"}
...
ROLE_MODULES={"administrator":ALL_MODULES,"clinician":ALL_MODULES,"nutritionist_dietitian":NUTRITION_MODULES,"disease_control_officer":PUBLIC_HEALTH_MODULES,"field_officer":ALL_MODULES,"opd_nurse":ALL_MODULES,"midwife":{"maternal_risk","anaemia_pregnancy","childhood_malnutrition"},"data_officer":set(),"pharmacist":set(),"laboratory_officer":set(),"records_officer":set(),"ward_nurse":set(),"theatre_staff":set(),"stores_officer":set(),"revenue_officer":set(),"accountant":set(),"insurance_officer":set()}
ROLE_VIEWS={"administrator":["care-network","screening","dashboard","surveillance","records","referrals","reviews","users","account","about"],"clinician":["care-network","screening","dashboard","records","referrals","reviews","account","about"],"nutritionist_dietitian":["care-network","screening","dashboard","records","referrals","reviews","account","about"],"disease_control_officer":["screening","dashboard","surveillance","records","referrals","reviews","account","about"],"field_officer":["screening","dashboard","records","referrals","reviews","account","about"],"opd_nurse":["care-network","screening","dashboard","records","referrals","reviews","account","about"],"midwife":["care-network","screening","records","referrals","reviews","account","about"],"records_officer":["care-network","account","about"],"laboratory_officer":["care-network","account","about"],"pharmacist":["care-network","account","about"],"ward_nurse":["care-network","account","about"],"theatre_staff":["care-network","account","about"],"stores_officer":["care-network","account","about"],"revenue_officer":["care-network","account","about"],"accountant":["care-network","account","about"],"insurance_officer":["care-network","account","about"],"data_officer":["dashboard","surveillance","records","reviews","account","about"]}
ROLE_VIEWS["data_officer"].insert(0,"care-network")
